...
<pre><code class="language-json">{
    ...
    "info": {
        "name": "Laravel API",
        "_postman_id": "d4ec0bfd-51dc-41a3-8b96-1e85c19e7453",
        "description": "",
            ...
            "item": [
                ...
                },
                {
                    ...
                    "request": {
                        "url": {
                            ...
                            "raw": "http:\/\/localhost\/api\/donation\/:id?id=quasi"
                        },
                        "method": "GET",
                        "header": [
                            {
                ...
                },
                {
                    ...
                    "request": {
                        ...
                        "body": {
                            "mode": "raw",
                            "raw": "{\n    \"donor_name\": \"voluptas\",\n    \"donation_details\": \"sequi\",\n    \"donation_type\": \"vero\",\n    \"donation_amount\": \"quia\",\n    \"source\": \"quam\"\n}"
                        },
                ...
                },
                {
                    ...
                    "request": {
                        ...
                        "body": {
                            "mode": "raw",
                            "raw": "{\n    \"state\": \"recusandae\",\n    \"donor_name\": \"assumenda\",\n    \"donation_details\": \"quia\",\n    \"donation_type\": \"excepturi\",\n    \"donation_amount\": \"eos\",\n    \"source\": \"est\"\n}"
                        },
...
&lt;div class="tocify-wrapper"&gt;
    ...
    &lt;/ul&gt;
            ...
            &lt;ul class="toc-footer" id="toc-footer"&gt;
                    ...
                    &lt;/ul&gt;
            &lt;ul class="toc-footer" id="last-updated"&gt;
            &lt;li&gt;Last updated: October 25 2020&lt;/li&gt;
        &lt;/ul&gt;
&lt;/div&gt;
&lt;div class="page-wrapper"&gt;
    &lt;div class="dark-box"&gt;&lt;/div&gt;
...
&lt;/blockquote&gt;
&lt;pre&gt;&lt;code class="language-bash"&gt;curl -X GET \
    -G "http://localhost/api/donation/{id}?id=quasi" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"&lt;/code&gt;&lt;/pre&gt;
&lt;pre&gt;&lt;code class="language-javascript"&gt;const url = new URL(
    "http://localhost/api/donation/{id}"
...
&lt;pre&gt;&lt;code class="language-bash"&gt;curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"donor_name":"voluptas","donation_details":"sequi","donation_type":"vero","donation_amount":"quia","source":"quam"}'
&lt;/code&gt;&lt;/pre&gt;
&lt;pre&gt;&lt;code class="language-javascript"&gt;const url = new URL(
    "http://localhost/api/donation"
);
...
&lt;pre&gt;&lt;code class="language-bash"&gt;curl -X PUT \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"state":"recusandae","donor_name":"assumenda","donation_details":"quia","donation_type":"excepturi","donation_amount":"eos","source":"est"}'
&lt;/code&gt;&lt;/pre&gt;
&lt;pre&gt;&lt;code class="language-javascript"&gt;const url = new URL(
    "http://localhost/api/donation/{id}"
);
